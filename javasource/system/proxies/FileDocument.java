...
public class FileDocument
{
	...
	public static system.proxies.FileDocument initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Xml", mendixObject.getType()))
			return myfirstmodule.proxies.Xml.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Xslt", mendixObject.getType()))
